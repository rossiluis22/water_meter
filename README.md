...
Now in your ```sensor.yaml``` enter your already copied sensor info. **NOTE** : you must calibrate your sensor by using measuring cup 1 liter, take note of how many pulses is 1L and divide it by the pulses **Ex: 1 Liter/607 (pulses)=0.001648** 
```  
     - platform: mqtt
